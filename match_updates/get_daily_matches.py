...
def compare_matches_and_update(db_matched, live_matches):
    changed_matches = compare_matches(db_matched, live_matches)

    # UPDATE MATCHES ON DB

    updated_matches = changed_matches
